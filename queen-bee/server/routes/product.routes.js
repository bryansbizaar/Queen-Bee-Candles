...
router.get("/:id/stock", checkStock); // Check stock availability
router.patch("/:id/stock", updateStock); // Update stock quantity (admin)
router.post("/:id/stock/adjust", adjustStock); // Adjust stock with reason tracking
router.get("/admin/low-stock", getLowStockProducts); // Get low stock products (admin)
